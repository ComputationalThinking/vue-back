  ...
  <div class="register-container">
    <el-card>
      ...
      <div class="form-container">
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="register-form" auto-complete="on" label-position="left">
        ...
        <el-button :loading="loading" type="primary" round style="width:80%;margin-bottom:30px;" @click.native.prevent="handleLogin">注册账号</el-button>
