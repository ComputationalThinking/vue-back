<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="120px">
      ...
      <el-row>
        <el-col :span="11">
          <el-form-item label="成果参与人员">
            <el-input v-model="form.participantMember" />
          </el-form-item>
        </el-col>
    ...
    dataPost() {
      this.$confirm('确认是否编辑完毕?', '提示', {
        ...
        if (this.operate === 2) {
          ...
          this.getContent()
          this.$axios
            .post('http://localhost:8083/achieve/updataID', this.form)
            .then(function(response) {
          ...
          this.getContent()
          this.$axios
            .post('http://localhost:8083/achieve/insertID', this.form)
            .then(function(response) {
              that.listLoading = false
            })
          this.$message({
